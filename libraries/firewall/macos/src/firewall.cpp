...
static const std::string pfctl = "/sbin/pfctl";

static const std::string primary_anchor = "osquery_firewall_pri";
static const std::string secondary_anchor = "osquery_firewall_sec";

static const std::string blocked_hosts_table = "blocked_hosts";
